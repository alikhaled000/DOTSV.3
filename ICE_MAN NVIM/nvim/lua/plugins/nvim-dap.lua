...
-- Already lazy-loaded via keys — no changes needed structurally.
-- DAP configs for C/C++/Rust moved here from init.lua.
...
return {
  {
    ...
    config = function()
      ...
      -- C / C++ / Rust configurations (moved from init.lua)
      ...
      -- Load env variables for Go
      local function load_env_variables()
        local variables = {}
        for k, v in pairs(vim.fn.environ()) do variables[k] = v end
