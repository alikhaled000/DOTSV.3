...
void FillArreyWithKeys(string arr[100], int arrLength) {
...
void PrintArray(string arr[100], int arrLength) {
  for (int i = 0; i < arrLength; i++)
    cout << "Numebr of Keys [" << i << "]" << " : " << arr[i] << endl;
  cout << "\n";
}
int main() {
  ...
  int arrLength = ReadPositiveNumber("Enter UR number OF Keys");
  string arr[100];
  FillArreyWithKeys(arr, arrLength);
